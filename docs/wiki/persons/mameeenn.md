...
## ひとりごと
メインサーバーは過疎り、 (しかも5月いっぱいやるし)
サブサーバーは人受け入れていない上しばらく閉鎖している。
そして開催予定のイベントは放棄されている。
もはやMinecraftよりVRChatのサーバーになりつつあるあっきーサーバーに私はいる価値があるのだろうか？
私自身、なぜVRCを嫌っているのかよくわかっていないが、
おそらく、当鯖でVRChatのチャンネルがNSFWにあったり、ほかの人の発言を見て、卑猥なコンテンツであると脳裏に焼き付けられたのだろう。
それに、VRChatに関係するあっきーの私への権限乱用も起因しているだろう。
だからVRCプレイヤーに違和感を持っているではないのだろうか...?
あっきーとみーてぅはVRCプレイヤー、はーすむは他管理者を嫌っていたりしていて、私から見て今の管理者の体制が違和感に感じるのかもしれない。
もちろんVRChatは悪いコンテンツではないだろうし、卑猥なことをするのもごく一部だろうが、それでも拒みたくなってしまう。
そして私には、このひとりごとを言い出せる場所がなかった。
仕方なく、見つけづらそうなここに上げることにした。

今が抜けるのには一番良いタイミングであるとは思っている。
しかし、あっきーサーバーは私の居場所である。
ここ以外にひとりごとをつぶやいたり、惚気話をできる,聞ける場所はないからだ。
私は、どこへ行けばいいものか。どこかあっきーサーバーから距離を置くことはできないのだろうか。

少しずつ居場所は失われていく。

2026年4月19日 18時37分

<!--注意: 上記のメッセージはプッシュ前に消去されるため、Github上のログ以外で残ることはありません。-->
</div>